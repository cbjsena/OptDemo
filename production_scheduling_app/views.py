...
def lot_sizing_introduction_view(request):
    ...
    return render(request, 'production_scheduling_app/under_construction.html', context) # 임시 페이지
...
def single_machine_introduction_view(request):
    ...
    return render(request, 'production_scheduling_app/under_construction.html', context)
